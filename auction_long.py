...
import time
import random
import ma_methods_long
import ma_operators_long

import agent_methods_long
import agent_operators_long
...
# Model setup
ma_m = ma_methods_long.get_methods()
ma_o = ma_operators_long.get_operators()

state1 = hop.State("state1")
state1.pos = {"p1":"l0","p2":"l0"}

goal1 = hop.Goal("goal1")
goal1.pos = {"p1":"l10","p2":"l10"}

# Generalized state for use
sa_m = agent_methods_long.get_methods()
sa_o = agent_operators_long.get_operators()
state1.pos["r"] = "l0"
...
for i in range(num_rounds):
    ...
    # print(elapsed_time)
print("AVERAGE RUONDS: {}".format(avg_rounds/num_rounds))
print("AVERAGE COST: {}".format(avg_cost/num_rounds))
print("AVERAGE TIME: {}".format(avg_time/num_rounds))